...
const instagramServiceRoutes = require("./routes/instagramService"); // ✅ ROTAS INSTAGRAM
app.use("/api", instagramServiceRoutes); // ✅ depois usa o app normalmente
...
const outrasRotasInstagram = require("./routes/instagram");
app.use("/api", outrasRotasInstagram);
